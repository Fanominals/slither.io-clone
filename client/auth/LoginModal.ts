export class LoginModal {
  ...
  private createModal(): HTMLElement {
    ...
    // Add event listeners
    const closeBtn = modal.querySelector('#loginModalClose') as HTMLElement;
    const overlay = modal.querySelector('.login-modal-overlay') as HTMLElement;
    const googleBtn = modal.querySelector('#googleSignInBtn') as HTMLElement;
  ...
  private resetGoogleButton(googleBtn: HTMLButtonElement): void {
  ...
  private async handleGoogleSignIn(): Promise<void> {
    const googleBtn = this.modal.querySelector('#googleSignInBtn') as HTMLButtonElement;
