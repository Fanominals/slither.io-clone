...
export class Input {
    ...
    private setupEventListeners(): void {
        ...
        // Setting up Input event listeners on canvas

        // Add event listeners and store references for cleanup
        document.addEventListener('mousemove', handleMouseMove); // Track mouse globally
    ...
    // Reset boosting state (useful for respawn)
