export class UsernameModal {
    ...
    `;
        // Add event listeners
        const closeBtn = modal.querySelector('#usernameModalClose');
        const overlay = modal.querySelector('.username-modal-overlay');
    ...
    async handleUsernameInput() {
        const usernameInput = this.modal.querySelector('#usernameInput');
        const saveBtn = this.modal.querySelector('#saveUsernameBtn');
        const statusText = this.modal.querySelector('#statusText');
        const statusSpinner = this.modal.querySelector('#statusSpinner');
