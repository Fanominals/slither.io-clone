const { initializeApp, getAuth, getFirestore, GoogleAuthProvider, signInWithPopup, signOut, onAuthStateChanged, doc, setDoc, getDoc, updateDoc, deleteDoc } = window.Firebase;
